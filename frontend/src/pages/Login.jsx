        ...
        >
          <div className="mb-8">
            ...
            <h1 className="font-serif text-3xl md:text-4xl text-white tracking-tight mb-2">
              Unlock your <span className="italic text-[#c8ff00]">vault</span>
            </h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
            ...
            <div className="flex items-center justify-between pt-2">
              <div className="flex items-start gap-2.5">
                ...
                />
                <label htmlFor="remember" className="text-xs text-[#8a8a8a] leading-relaxed cursor-pointer font-mono">
                  Remember me
                </label>
              </div>
              <a href="#" className="text-xs text-[#c8ff00] hover:underline font-mono">
                Forgot password?
              </a>
            </div>
