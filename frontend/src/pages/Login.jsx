    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
        <motion.div
          ...
          className="bg-[#111111] border border-[#2a2a2a] rounded-lg p-10 text-center max-w-sm w-full"
        >
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="relative bg-[#111111] border border-[#2a2a2a] rounded-lg p-8 md:p-10 max-w-md w-full"
      >
        <div className="mb-8">
